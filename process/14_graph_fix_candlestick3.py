...
#make the wick vline correspond to the colorup and colordown by adding the vline function to the up and down functions and assign the color the colorup and color down colors

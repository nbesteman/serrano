#https://www.youtube.com/watch?v=t_JXXT7VgeQ
#how to calc exponenetial moving average
...
#so we need a function for an esponential moving average and then the macd function
...
eachStock = 'UNG','USO','GOV','SLV'
#14 is the default period (is this last 14 days?)
#100/1-releative strenght
...
def ExpMovingAverage(values,window):
    weights =np.exp(esp(np.linespace(-1., 0., window))
